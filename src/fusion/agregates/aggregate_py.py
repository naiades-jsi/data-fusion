...
class AggregatePy(Aggregate):
    """
    Create aggregates with Pandas in Python.
    """

    # aggregates calculated with python
    ...
    def aggregate_rolling(self, agr='mean', every:str = '5m', window:str = '5min',  start_time = None, stop_time = '-0h', measurement = '', fields = [], tags = {None: None}):
    ...
    def aggregate_time(self, agr = 'mean', every:str = '5m', window:str = '5min',  start_time = None, stop_time = '-0h', shift= '0h', measurement = '', fields = [], tags = {None: None}, offset=None):
        if start_time is None:
            start_time = '-' + window
