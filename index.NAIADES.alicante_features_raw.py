...
def RunBatchFusionOnce():
    ...
    file_json = open(f'{folder}/features_alicante_salinity_EA003_36_conductivity_raw.json', 'r')
    ...
    file_json = open(f'alicante_salinity_salinity_EA003_36_conductivity_raw_config.json', 'w')
    ...
    if(update_outputs):
      file_json = open(f'{folder}/features_alicante_salinity_EA003_36_conductivity_raw.json', 'a')
      ...
      for j in range(t.shape[0]):
          ...
          output_topic = "features_alicante_salinity_EA003_36_conductivity"
