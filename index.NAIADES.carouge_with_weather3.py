...
def RunBatchFusionOnce():
    ...
    file_json = open(f'{folder}/features_carouge_3.json', 'r')
    ...
    file_json = open(f'config_carouge_3.json', 'w')
    ...
    if(update_outputs):
      ...
      file_json = open(f'{folder}/features_carouge_3.json', 'a')
      ...
      for j in range(t.shape[0]):
          ...
          output_topic = "features_carouge_flowerbed3"
